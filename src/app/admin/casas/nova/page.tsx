...
export default function NovaCasaPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const properties: Property[] = savedProperties ? JSON.parse(savedProperties) : [];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Nova Casa</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              ...
              <input
                ...
                required
                placeholder="Ex: Casa do Lago Vista Azul"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
                placeholder="Descreva a casa, suas características e diferenciais..."
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
              ...
              <input
                ...
                placeholder="Ex: 10"
              />
              <p className="text-xs text-gray-500 mt-1">Número de pessoas</p>
            </div>
